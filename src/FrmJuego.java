    ...
    private void btnVerificarClick(ActionEvent evt) {
        switch (tpJugadores.getSelectedIndex()) {
            case 0:
                ...
                JOptionPane.showMessageDialog(null, "Puntaje: " + jugador1.calcularPuntaje());
                jugador1.ordenarEscaleras(); // Organiza las cartas en escalera
                jugador1.mostrar(pnlJugador1); // Refresca la visualización
                break;
            case 1:
                JOptionPane.showMessageDialog(null, jugador2.getGrupos());
                JOptionPane.showMessageDialog(null, "Puntaje: " + jugador2.calcularPuntaje());
                jugador2.ordenarEscaleras();
                jugador2.mostrar(pnlJugador2);
                break;
        }
    }
